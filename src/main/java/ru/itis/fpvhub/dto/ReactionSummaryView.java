...
public class ReactionSummaryView {
    private final long likes;
    private final long dislikes;
    private final ArticleReactionType currentUserReaction;

    public ReactionSummaryView(long likes, long dislikes, ArticleReactionType currentUserReaction) {
        this.likes = likes;
    ...
    public boolean isLikedByCurrentUser() {
        return ArticleReactionType.LIKE.equals(currentUserReaction);
    }

    public boolean isDislikedByCurrentUser() {
        return ArticleReactionType.DISLIKE.equals(currentUserReaction);
    }
}
