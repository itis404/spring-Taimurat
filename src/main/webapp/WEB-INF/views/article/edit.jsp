...
<main class="container page narrow">
    <section class="card">
        ...
        <p class="muted">После изменения опубликованная статья снова попадёт на модерацию, если вы отправите её на проверку</p>

        <form:form cssClass="form" method="post" action="${pageContext.request.contextPath}/articles/${articleId}/edit" modelAttribute="articleForm">
